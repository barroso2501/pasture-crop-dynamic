...
VERSION = "phase8d-maup-global-moran-v1"
...
def seed_for(grid_code: str, metric: str, t0: int) -> int:
    text = f"{MASTER_SEED}|{VERSION}|{grid_code}|{metric}|{t0}"
...
def run(args) -> None:
    ...
    graph_objects = {}
    graph_rows = [{"grid_code": "hex20k_canonical", "support_rule": "complete_canonical_cells", **canonical_graph_diagnostics}]
    for grid_code in ALTERNATIVE_GRIDS:
    ...
    checkpoint_design = {
        "script_version": VERSION, "permutations": args.permutations,
