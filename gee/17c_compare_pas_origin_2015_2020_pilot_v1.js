...
var NAME = 'canonical_pas_origin_2015_2020_pilot_v1';
...
var reduced = ee.Image.cat(bands).reduceRegions({
  ...
  crsTransform:K.CRS_TRANSFORM, tileScale:8, maxPixelsPerRegion:30000000
});
var exported = reduced.map(function (f) {
  return ee.Feature(null, f.toDictionary(selectors.slice(6))).set({
    ...
    output_version:'pas-origin-reconstruction-pilot-v1'
  });
});

print('RQ2 PASTURE-ORIGIN IMPACT PILOT — 2015–2020');
