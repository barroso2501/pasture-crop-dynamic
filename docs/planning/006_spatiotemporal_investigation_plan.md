...
- **Status:** Approved; Phases 0-3B and temporal production Phase 4A passed; interpretation is next
- **Date recorded:** 2026-09-12
- **Last design update:** 2026-09-15 — Decision 010; Phase 4A production accepted following Colab and GIS review
...
The repository script path above should contain the accepted revision-2 bytes;
the actual Colab execution used `09a_build_cell_state_trajectories_v2.py`.
No rerun is required for this acceptance. Explore the temporal findings before
making substantive claims of annual persistence, development stages or spatial
relocation. Later Moran/LISA analyses remain under Phases 5 and 6.
