...
- **Status:** Approved; Phases 0-2 passed, Phase 3A diagnostic completed, and
  final class-limit refitting is authorized
...
The other ten Phase 3A class specifications passed review. The preliminary
two share limits must be recalculated from eligible observations in the seven
primary intervals. Phase 3B map production remains blocked until the revised
Phase 3A output passes validation. Evidence and definitions are recorded in:
