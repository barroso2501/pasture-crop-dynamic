...
- **Status:** Approved; Phases 0–7 and Phases 8A–8D complete and accepted; broad cluster-location robustness is next
- **Date recorded:** 2026-09-12
- **Last implementation update:** 2026-09-20 — Phase 8D completed and accepted
...
Phase 8 remains open for a broad, prespecified comparison of cluster location
and persistence; alternative-grid results will not replace the canonical
Local Moran/LISA analysis.
