...
- **Status:** Accepted; 2005-2010 pilot validated; full temporal series pending
...
reconciliation checks. The validation record is:
...
historical processing. This difference does not invalidate the pilot because
the historical output used a preliminary coverage source and a different
domain. The canonical result is not required to reproduce it. The difference
will remain an explicit diagnostic until the complete temporal series is
processed and its source- and interval-related patterns can be evaluated.

## Next implementation step

Apply the validated pilot design without methodological changes to the seven
remaining five-year intervals. After processing, assemble and validate the
balanced trajectory panel before selecting the primary trajectory rule or
starting Moran, MAUP, or substantive spatial analyses.
