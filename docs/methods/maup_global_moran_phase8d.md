...
SHA-256: 3a28624bf1e53218537d923a244eac10b5e14b154b3b903e5454c355a234e009
```

The analytical and checkpoint identity remains
`phase8d-maup-global-moran-v1`. Revision 2 changes only strict JSON
serialization of the canonical graph diagnostic and therefore reuses the
revision-1 permutation checkpoints without changing their seeds or results.
