...
- **Canonical repository implementation:** `analysis/09a_build_cell_state_trajectories.py`, revision 3, SHA-256 `ed2ded69036cb460fb659e16aaeb9fda3456b557e91b6cd7cb6c53a5944fa58e`.
- **Executed production implementation:** `09a_build_cell_state_trajectories_v2.py`, version `phase4a-cell-trajectories-v2`, SHA-256 `8500ad7e08bf21d972a660449e9a635ee1c3c92947fc9a3ce1fd3d42a2d386ec`.
- **Revision relationship:** revision 2 introduced the authenticated support-column projection fix; revision 3 is numerically equivalent and only removes the invalid GIS `CharacterSet=65001` option, updates the version string and updates the Console banner.
- **Production status:** Canonical temporal production accepted on 2026-09-15; Phase 4 interpretation and synthesis subsequently completed.
