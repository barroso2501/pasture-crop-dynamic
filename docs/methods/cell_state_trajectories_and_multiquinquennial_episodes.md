...
- **Implementation:** `analysis/09a_build_cell_state_trajectories.py`.
- **Script version:** `phase4a-cell-trajectories-v1`.
- **Production status:** Prepared; canonical Colab execution and result acceptance pending.
