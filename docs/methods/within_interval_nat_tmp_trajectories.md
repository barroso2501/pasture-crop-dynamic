...
- **Status:** Method fixed; 2005-2010 full-domain pilot validated; remaining intervals pending
...
`docs/validation/nat_tmp_trajectory_2005_2010.md` and must be reassessed after
the complete eight-interval series is available.

## Current implementation status

The 2005-2010 pilot is the validated implementation reference for subsequent
intervals. Production processing must preserve the same:
...
The method is fixed for expansion, but the choice between the inclusive and
persistence-sensitive rules for the primary scientific interpretation remains
open until all eight intervals have been processed and compared.

Only after the pilot passes will the remaining seven intervals be exported.
The 2020-2025 interval will be marked as diagnostic.
