...
- **Status:** Method fixed; full-domain pilot prepared
...
The first execution uses the complete 24,889-cell domain for 2005-2010. It is
accepted only after checking:
