...
### P9A001 — fixed_1985_pasture_cohort

The accepted spatial investigation does not yet contain a dedicated substantive synthesis of redistribution of the fixed 1985 pasture cohort.

- **Evidence:** No Phase 4-8 accepted finding answers RQ1 directly.
- **Mode:** gap; status: evidence_gap
- **Temporal role:** both (1985_2025)
- **MAUP/robustness:** not_assessed
- **Boundary:** Do not infer redistribution results from process-flow maps; extract the accepted cohort-accounting outputs before manuscript synthesis.
- **Source:** Phase 0-9, `planning/006_spatiotemporal_investigation_plan.md` — Research question 1 and fixed-cohort component


## RQ2

### P9A002 — pasture_origin_of_consolidation

The accepted spatial investigation does not yet synthesize the shares of consolidation originating from left-censored, new, unresolved-age and unattributed pasture.

- **Evidence:** No Phase 4-8 accepted finding provides the complete origin partition required by RQ2.
- **Mode:** gap; status: evidence_gap
- **Temporal role:** both (1985_2025)
- **MAUP/robustness:** not_assessed
- **Boundary:** The accounting identity may be validated upstream, but substantive origin shares require a dedicated extraction from accepted stock-flow outputs.
- **Source:** Phase 0-9, `planning/006_spatiotemporal_investigation_plan.md` — Research question 2 and pasture-origin identity
...
- **Mode:** descriptive; status: supported
...
- **Mode:** descriptive; status: qualified
- **Temporal role:** primary (1985_2020)
- **MAUP/robustness:** not_applicable
...
- **Mode:** global_inference; status: supported
- **Temporal role:** both (1985_2025)
- **MAUP/robustness:** not_assessed
...
- **Mode:** global_inference; status: qualified
- **Temporal role:** primary (1985_2020)
- **MAUP/robustness:** not_assessed
...
- **Mode:** local_inference; status: supported
- **Temporal role:** primary (1985_2020)
- **MAUP/robustness:** not_assessed
...
- **Mode:** sensitivity; status: qualified
- **Temporal role:** both (1985_2025)
- **MAUP/robustness:** sensitive
...
- **Mode:** sensitivity; status: supported
- **Temporal role:** both (1985_2025)
- **MAUP/robustness:** robust
...
- **Mode:** limitation; status: qualified
- **Temporal role:** both (1985_2025)
- **MAUP/robustness:** not_applicable
...
- **Mode:** sensitivity; status: supported
- **Temporal role:** both (1985_2025)
- **MAUP/robustness:** partially_robust
