...
**Current status: canonical inputs and analytical domain validated; the complete 1985–2025 five-year stock-and-flow series and `NAT → TMP` within-interval trajectory series have been reprocessed, assembled, validated, and integrated into a canonical 199,112-row analytical panel. The runtime-provenance gate passed without requiring reprocessing. Phase 1 produced a validated 24,889-cell spatial table and a fixed graph with 67,453 shared-edge links. Phase 2 joined this support to the integrated panel, validated process-specific spatial metrics, and documented the changing active-cell subgraph for each interval. Phase 3, construction of fixed comparable map classes and interval map series, is the next stage.**
