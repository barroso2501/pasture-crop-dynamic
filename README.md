...
**Current status: canonical inputs and analytical domain validated; the complete 1985–2025 five-year stock-and-flow series and `NAT → TMP` within-interval trajectory series have been reprocessed, assembled into balanced panels, and passed structural and accounting validation. Integration of the two canonical analytical tables is the next computational stage.**
